...
export var south_face = -1 setget set_south
export var west_face = -1 setget set_west
export var top_face = -1 setget set_top
export var bottom_face = -1 setget set_bottom

export var flip_faces = false setget set_flip_faces
